      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2 p-1 bg-muted/50 rounded-lg">
            <TabsTrigger value="style" className="data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm">
              Style Analysis
            </TabsTrigger>
            <TabsTrigger value="moodboard" className="data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm">
              Moodboard
            </TabsTrigger>
            <TabsTrigger value="forecast" className="data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm">
              Trend Forecast
            </TabsTrigger>
            <TabsTrigger value="tryon" className="data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm">
              Try-On
            </TabsTrigger>
            <TabsTrigger value="campaign" className="data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm">
              Campaign
            </TabsTrigger>
            <TabsTrigger value="closet" className="data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm">
              Closet
            </TabsTrigger>
          </TabsList>
